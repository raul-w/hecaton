...
nextflow run -w functional_workdir -with-docker hecaton:v0.2.2 -c ../nextflow/nextflow.config -resume ../nextflow/hecaton.nf \
...
nextflow run -w functional_workdir_empty -with-docker hecaton:v0.2.2 -c ../nextflow/nextflow.config -resume ../nextflow/hecaton.nf \
	--genome_file ../tests/functional/test.fa \
...
nextflow run -w functional_workdir_no_align -with-docker hecaton:v0.2.2 -c ../nextflow/nextflow.config -resume ../nextflow/hecaton_no_align.nf \
	--genome_file ../tests/functional/test.fa \
